 ...
 */
final class WPBC_Booking_Modes_V3_Page_Registry {

	/**
	 * Shared page registry instance.
	 *
	 * @var WPBC_Booking_Modes_V3_Page_Registry|null
	 */
	 ...
	 *
	 * @return WPBC_Booking_Modes_V3_Page_Registry Page registry instance.
	 */
	...
	public function get_all() {
		...
		foreach ( $pages as $page_id => $page ) {
			if ( isset( $page['title'] ) && is_string( $page['title'] ) ) {
				$pages[ $page_id ]['title'] = translate( $page['title'], 'booking' );
			}
		}
	...
	private function normalize_pages( $pages ) {
		...
		foreach ( array_slice( $pages, 0, WPBC_Booking_Modes_V3_Definition_Validator::MAX_COLLECTION_ENTRIES, true ) as $page_id => $page_definition ) {
