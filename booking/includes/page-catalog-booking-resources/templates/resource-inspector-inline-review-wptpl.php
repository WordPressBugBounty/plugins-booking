<?php
/**
 * Signed row-specific inline review template.
 *
...
?>
<script type="text/html" id="tmpl-wpbc-booking-resource-inspector-inline-review">
	<form id="{{ data.form_id }}" class="wpbc_catalog_booking_resources__editor wpbc_ui_catalog_inline_review" data-wpbc-ui-catalog-inline-review-form data-wpbc-catalog-inline-review-form data-mode="{{ data.mode }}">
		...
		<div class="wpbc_ui_catalog_inline_review__content" data-wpbc-ui-catalog-inline-review-content>
