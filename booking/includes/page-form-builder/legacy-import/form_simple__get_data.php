 ...
 *
 * Previously this data was saved into booking_form; now it is converted/imported into BFB storage.
 *
...
//						$html_form .= '	</r>' . "\n";                                       // FixIn: 10.7.1.6.
		...
		// -------------------------------------------------------------------------------------------------------------
		// Legacy Simple form conversion helpers used by the BFB importer.
		// -------------------------------------------------------------------------------------------------------------
